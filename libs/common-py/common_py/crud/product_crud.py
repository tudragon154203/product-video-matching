...
class ProductCRUD:
    ...
    async def create_product(self, product: Product) -> str:
        ...
        query = """
        INSERT INTO products (product_id, src, asin_or_itemid, title, brand, url, marketplace, job_id)
        VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
        RETURNING product_id
        """
        return await self.db.fetch_val(
            query, product.product_id, product.src, product.asin_or_itemid,
            product.title, product.brand, product.url, product.marketplace, product.job_id
        )
