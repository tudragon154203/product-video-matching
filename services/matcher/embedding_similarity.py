...
logger = configure_logging("embedding_similarity")


class EmbeddingSimilarity:
    """Module for calculating cosine similarity between image and video embeddings"""
    
    def __init__(self, threshold: float = 0.82):
        self.threshold = threshold
        self.weights = {
            'rgb': 0.7,      # RGB embedding weight
            'gray': 0.3      # Grayscale embedding weight
        }
