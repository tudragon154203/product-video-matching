...
This directory contains the test suite for the `vision-keypoint` microservice. It is organized into `unit`, `integration`, and `contract` tests, along with shared `fixtures` and `data`.
