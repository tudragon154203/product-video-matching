    ...
    try:
        ...
        try:
            ...
            if "All connection attempts failed" in error_str or "Connection refused" in error_str:
                print(
                    "WARNING: Could not connect to Ollama service. This is expected if Ollama is not running.")
                print(
                    "To run this test successfully, please ensure Ollama is installed and running on your system.")
