...
class TestDatabaseHandler:
    ...
    async def test_get_job_asset_types_with_images_and_videos(self, db_handler):
        ...
        db_handler.get_job_counts = AsyncMock(return_value=(5, 3, 10))  # 5 products, 3 videos, 10 matches
    ...
    async def test_get_job_asset_types_database_error_fallback(self, db_handler):
        ...
        db_handler.get_job_counts = AsyncMock(side_effect=Exception("Database error"))
