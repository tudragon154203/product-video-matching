...
class LifecycleHandler:
    ...
    async def startup(self):
        ...
        try:
            ...
            logger.warning(
                f"Failed to connect to database: {e}. Continuing without database connection.")
        ...
        try:
            ...
            logger.warning(
                f"Failed to connect to message broker: {e}. Continuing without broker connection.")
    ...
    async def subscribe_to_phase_events(self):
        ...
        try:
            ...
            await self.broker.subscribe_to_topic(
                ...
                lambda event_data: self.job_service.handle_phase_event(
            ...
            await self.broker.subscribe_to_topic(
                ...
                lambda event_data: self.job_service.handle_phase_event(
                    "matchings.process.completed", event_data),
            ...
            await self.broker.subscribe_to_topic(
                ...
                lambda event_data: self.job_service.handle_phase_event(
                    "evidences.generation.completed", event_data),
            ...
            logger.error(
                "Failed to subscribe to job-based completion events", error=str(e))
