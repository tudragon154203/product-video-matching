...
def mock_auth_service(mock_redis):
    ...
    auth._retrieve_token = AsyncMock(return_value={"access_token": "test_token_123", "expires_at": 9999999999})
...
def ebay_collector(mock_auth_service, mock_redis):
    ...
    with patch('config_loader.config.EBAY_MARKETPLACES', "EBAY_US,EBAY_UK,EBAY_DE"):
        with patch('collectors.ebay_product_collector.EbayBrowseApiClient') as mock_browse_client_class:
