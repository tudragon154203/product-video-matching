...
All tests use the same mock data fixtures from `tests/mock_data/verify_fixtures.py`:

- **Products**: `products_images_ready_batch`, individual product events
- **Videos**: `videos_keyframes_ready_batch`, individual video events
- **Completion events**: Masking, embedding, keypoint completion events
- **Error cases**: Partial batches, corrupted data scenarios
